...
const checkForEmpty = (...inputs) => {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMessage(input, 'campo nao pode estar vazio');
    });
};
const hideErrorMSG = (form) => {
    form
...
/*!***************************************!*\
  !*** ./src/aula0018-webpack/index.ts ***!
  \***************************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
__webpack_require__(/*! ./mod */ "./src/aula0018-webpack/mod.ts");
